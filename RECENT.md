...
### blindgate
```
911197d polish run 1: layout fixes + flow-guidance stepper (tasks 1–2)
...
ae164d8 Make section headings editable
4c55af9 Make the use-case cards editable
a6a24af Show login button only when the owner's key is active
a5aa978 Add Perry-only inline WYSIWYG editing (text + screenshots)
