...
- [Analytics pulses](project_analytics_pulses.md) — Commy DMs Perry a daily web-visitor pulse + weekly Nostr flock-traction pulse (private; bots stripped; honest caveats)
